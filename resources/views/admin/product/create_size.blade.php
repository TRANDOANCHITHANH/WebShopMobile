                ...
                <div class="card-body">
                    <form method="post" id="formdata" enctype="multipart/form-data"
                        ...
                        <div class="position-relative row form-group">
                            <label for="size" class="col-md-3 text-md-right col-form-label">Thông số sản phẩm</label>
                            <div class="col-md-5 col-xl-5">
                                <input required name="size" id="size" placeholder="Thông số sản phẩm"
                            ...
                            <div class="col-md-2 col-xl-2">
                                <select required name="type_size" id="capacity" placeholder="Thông số sản phẩm"
                                    type="number" class="form-control input">
