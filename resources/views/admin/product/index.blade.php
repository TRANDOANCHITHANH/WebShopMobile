...
<div class="app-main__inner">
    <div class="app-page-title d-flex justify-content-between align-items-center p-3 bg-white shadow-sm rounded">
        <div class="d-flex align-items-center">
            <div class="page-title-icon bg-primary text-white rounded-circle p-2 me-3">
                <i class="bi bi-ticket-perforated fs-4"></i>
            </div>
            <div>
                <h4 class="mb-0 fw-bold text-dark">Quản lý Sản phẩm</h4>
                <small class="text-muted">Xem, tạo, cập nhật, xóa và quản lý.</small>
            </div>
        </div>

        <a href="{{ route('admin.product.create') }}" class="btn btn-primary px-4 py-2 shadow-sm">
...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).on('click', '.detail-product', function() {
            ...
            let url = '{{ route("admin.product.product_size.list_product_size", ":id") }}';
