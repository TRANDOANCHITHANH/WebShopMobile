    ...
    <div class="card overflow-hidden">
        <div class="row no-gutters row-bordered row-border-light">
            <div class="col-md-3 pt-0">
                <div class="list-group list-group-flush account-settings-links" style="flex-direction: initial;">
                            ...
                            <tbody>
                                ...
                                <tr class="item-order">
                                    ...
                                    <td class="d-flex justify-content-center text-center">
                                        ...
                                        data-original-title="Xem chi tiết"><i class="fas fa-eye text-primary mr-1 "></a>
                                    </td>
